...
const { OWNER_ADDRESS, USDO_ADDRESS, PROXY_ADDRESS } = process.env;
// const contractName = 'USDO';
// const initializerArgs = ['OpenEden Open Dollar', 'USDO', OWNER_ADDRESS];
// const salt = '1337';

const contractName = 'wUSDO';
const initializerArgs = [USDO_ADDRESS, OWNER_ADDRESS];
const salt = '1337w';
