...
/**
 * @title Wrapped OpenEden Protocol USDO
    ...
    EIP712Upgradeable
{
    ...
    function initialize(IUSDO _USDO, address owner) external initializer {
        ...
        __ERC20_init("Wrapped OpenEden Protocol USD", "wUSDO");
        __ERC4626_init(_USDO);
        __AccessControl_init();
        __Pausable_init();
        __UUPSUpgradeable_init();
        __EIP712_init("Wrapped OpenEden Protocol USD", "1");
     ...
     * @return Returns true if USDO or wUSDO is paused, and false otherwise.
     */
    ...
    function _beforeTokenTransfer(address from, address to, uint256 amount) internal virtual override {
        ...
        if (USDO.isBanned(from)) {
            revert wUSDOBlockedSender(from);
        }
